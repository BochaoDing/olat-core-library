...
public class CampusCourseGroupSynchronizerITCase extends OlatTestCase {
    ...
    public void setup() {
        ...
        courseGroupSynchronizerTestObject.setCampusConfiguration(campusConfigurationMock);
        courseGroupSynchronizerTestObject.getCampuskursCoOwners().setCampusConfiguration(campusConfigurationMock);
        ...
        RepositoryEntry sourceRepositoryEntry = JunitTestHelper.deployDemoCourse(ownerIdentity); // TODO OLATng - is this acceptable identity?
