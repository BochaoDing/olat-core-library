...
public class UserAdminBusinessGroupListController extends AbstractBusinessGroupListController {
	...
	protected FlexiTableColumnModel initColumnModel() {
		...
		//group name
		columnsModel.addFlexiColumnModel(new DefaultFlexiColumnModel(BusinessGroupListFlexiTableModel.Cols.name.i18n(), BusinessGroupListFlexiTableModel.Cols.name.ordinal(), TABLE_ACTION_LAUNCH,
		...
		//actions
		columnsModel.addFlexiColumnModel(new DefaultFlexiColumnModel(BusinessGroupListFlexiTableModel.Cols.allowLeave.i18n(), BusinessGroupListFlexiTableModel.Cols.allowLeave.ordinal(), TABLE_ACTION_LEAVE,
