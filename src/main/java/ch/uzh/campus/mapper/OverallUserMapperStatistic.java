...
public class OverallUserMapperStatistic {
    ...
    OverallUserMapperStatistic(MappingStatistic lecturersMappingStatistic, MappingStatistic studentMappingStatistic) {
        this.lecturersMappingStatistic = lecturersMappingStatistic;
        this.studentMappingStatistic = studentMappingStatistic;
    }

    public String toString() {
        return "Lecturer Mapping Statistic: "
                + lecturersMappingStatistic
                + " ; Student Mapping Statistic: "
                + studentMappingStatistic;
    }
