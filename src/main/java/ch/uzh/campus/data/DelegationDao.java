...
public class DelegationDao implements CampusDao<Delegation> {
    ...
    Delegation getDelegationById(Long delegatorKey, Long delegateeKey) {
        return dbInstance.getCurrentEntityManager().find(Delegation.class, new DelegatorDelegateeId(delegatorKey, delegateeKey));
    }

    boolean existsDelegation(Long delegatorId, Long delegateeId) {
    ...
    void deleteDelegationById(Long delegatorKey, Long delegateeKey) {
