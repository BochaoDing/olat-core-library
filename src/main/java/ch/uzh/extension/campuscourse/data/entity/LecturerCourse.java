...
@NamedQueries({
        @NamedQuery(name = LecturerCourse.GET_ALL_NOT_UPDATED_LC_BOOKING_OF_CURRENT_SEMESTER, query = "select new ch.uzh.extension.campuscourse.model.LecturerIdCourseId(lc.lecturer.personalNr, lc.course.id) from LecturerCourse lc " +
