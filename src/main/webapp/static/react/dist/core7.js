 ...
 */
var OLATComponent = function (_React$Component) {
    _inherits(OLATComponent, _React$Component);

    function OLATComponent(props) {
        _classCallCheck(this, OLATComponent);

        var _this = _possibleConstructorReturn(this, (OLATComponent.__proto__ || Object.getPrototypeOf(OLATComponent)).call(this, props));

        var language = props.language || _this.getDefaultLanguage();
        var listeners = props.listeners || [];
        _this.state = {
            listeners: listeners,
            language: language,
            i18n: _this.getTranslations(language)
        };
        return _this;
    }

    _createClass(OLATComponent, [{
        key: 'onEvent',
        value: function onEvent(cmd, params) {
            // subclass if OLATComponent might override this method when it knows how to react to the event.
            //  otherwise, super.onEvent(cmd, params) will send the message further to any registered listeners.
            this.sendMessage(cmd, params);

            // possible implementation of onEvent is calling OLAT backend with AJAX call.
            //  for that, we need to construct an o_XHREvent, e.g.:
            //  return o_XHREvent('/auth/1:1:1000000436:1:1/',true,true,'cid','create.new.meeting');
        }
    }, {
        key: 'sendMessage',
        value: function sendMessage(cmd, params) {
            console.log('OLATComponent.sendMessage()', cmd, params);
            var listeners = this.state.listeners || [];
            listeners.forEach(function (listener) {
                if ('onEvent' in listener) {
                    listener.onEvent(cmd, params);
                }
            });
        }
    }, {
        key: 'getTranslations',
        value: function getTranslations(language) {
            // when subclass of OLATComponent has its i18n strings, add them here
        ...
        value: function translate(key) {
            var translations = _extends({}, this.state.i18n);
            return key in translations ? translations[key] : key;
        }
    }]);

    return OLATComponent;
}(_react2.default.Component);

exports.default = OLATComponent;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(10),n=__webpack_require__(11),p=__webpack_require__(7);
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(14),A=__webpack_require__(15),B=__webpack_require__(5),ca=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),ha=__webpack_require__(19),ia=__webpack_require__(20),C=__webpack_require__(21);
...
exports.fromOlatTimestamp = fromOlatTimestamp;
...
var _OLATComponent2 = __webpack_require__(29);

var _OLATComponent3 = _interopRequireDefault(_OLATComponent2);
...
/**
 * expected props:
 *   columnInfo : object that contains 'name', 'label' and 'sortable' keys
 *   sortColumn : name of the column that should be rendered as current sorting key
 *   sortAsc : boolean flag that shows direction of sorting for sortColumn
 *   index : a key for <th> - when not given, default to columnInfo.name
 */
var OLATSortableTableColumnHeader = function (_OLATComponent) {
    _inherits(OLATSortableTableColumnHeader, _OLATComponent);

    function OLATSortableTableColumnHeader() {
        _classCallCheck(this, OLATSortableTableColumnHeader);

        return _possibleConstructorReturn(this, (OLATSortableTableColumnHeader.__proto__ || Object.getPrototypeOf(OLATSortableTableColumnHeader)).apply(this, arguments));
    }

    _createClass(OLATSortableTableColumnHeader, [{
        key: 'render',
        value: function render() {
            var _this2 = this;

            var columnInfo = _extends({}, this.props.columnInfo);
            var sortColumn = this.props.sortColumn || '';
            var sortAsc = this.props.sortAsc || true;
            var index = this.props.index || name;

            var sortable = columnInfo.sortable || false;
            ...
            if (sortable) {
                ...
                if (name === sortColumn) {
                    columnClasses.push(sortAsc ? 'o_orderby_asc' : 'o_orderby_desc');
                }
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { className: columnClasses.join(' '), href: 'javascript:', onClick: function onClick() {
                                _this2.onEvent('sort', { column: name });
                            } },
                        label
                    )
                );
    ...
    return OLATSortableTableColumnHeader;
}(_OLATComponent3.default);

exports.default = OLATSortableTableColumnHeader;
...
exports.renderMeetings = renderMeetings;
...
var _Meetings = __webpack_require__(76);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function renderMeetings(rootElementId, params) {
    (0, _dom.waitForElement)(rootElementId, 500, 0, function () {
        _reactDom2.default.render(_react2.default.createElement(_Meetings.Meetings, { courseId: params.courseId, nodeId: params.nodeId }), document.getElementById(rootElementId));
    }, function () {
        console.log('Did not find ' + rootElementId + ' element during >=500ms, gave up trying');
    });
}
...
function waitForElement(elementId, maxWaitingTime, waited, onSuccess, onFailure) {
    var element = document.getElementById(elementId);
    console.log('waitForElement', elementId, element, waited);
    if (element) {
        onSuccess();
    } else {
        if (waited >= maxWaitingTime) {
            ...
            setTimeout(function () {
                waitForElement(elementId, maxWaitingTime, waited + 50, onSuccess, onFailure);
            }, 50);
        }
    }
}
...
var _OLATModal = __webpack_require__(77);

var _OLATModal2 = _interopRequireDefault(_OLATModal);

var _OLATLoadingIndicator = __webpack_require__(78);

var _OLATLoadingIndicator2 = _interopRequireDefault(_OLATLoadingIndicator);

var _api = __webpack_require__(79);

var _time = __webpack_require__(68);

var _MeetingsTable = __webpack_require__(80);
 ...
 *  nodeId: number
 */
var Meetings = exports.Meetings = function (_OLATComponent) {
    _inherits(Meetings, _OLATComponent);

    function Meetings(props) {
        _classCallCheck(this, Meetings);

        var _this = _possibleConstructorReturn(this, (Meetings.__proto__ || Object.getPrototypeOf(Meetings)).call(this, props));
        ...
        _this.setModalInfo = _this.setModalInfo.bind(_this);
        return _this;
    }
    ...
    _createClass(Meetings, [{
        ...
        value: function componentDidMount() {
            var vm = this;
            _axios2.default.get((0, _api.getApiEndpoint)('listmeetings', { courseId: this.props.courseId, nodeId: this.props.nodeId })).then(function (response) {
                vm.setState({ loading: false, meetings: response.data });
        ...
        value: function render() {
            ...
            var pastMeetings = [],
                futureMeetings = [];
            var meetings = [].concat(_toConsumableArray(this.state.meetings));
            var currentTime = new Date().getTime();
            meetings.forEach(function (meetingInfo) {
                if (meetingInfo.end < currentTime) {
                    pastMeetings.push(meetingInfo);
                } else {
                    futureMeetings.push(meetingInfo);
                }
            });

            // render modal dialog if state requires so
            var modal = _react2.default.createElement('div', null);
            if (this.state.modal && Object.keys(this.state.modalInfo).length > 0) {
                var modalInfo = this.state.modalInfo || {};
                if (this.state.modal === 'edit') {
                    var modalButtons = [{ label: this.translate('btn.save'), callback: function callback() {
                            return _this2.onEvent('save', modalInfo);
                        } }, { label: this.translate('btn.cancel'), callback: function callback() {
                            return _this2.onEvent('closeModal');
                        } }];
                    modal = _react2.default.createElement(
                        _OLATModal2.default,
                        { displayed: true, title: this.translate('modal.title.edit'), buttons: modalButtons, onClose: function onClose() {
                                return _this2.onEvent('closeModal');
                            } },
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    _react2.default.createElement('input', { type: 'text', value: modalInfo.name, onChange: function onChange(e) {
                                            return _this2.setModalInfo('name', e.target.value);
                                        } })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    this.translate('form.start')
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    _react2.default.createElement('input', { type: 'text', value: (0, _time.fromOlatTimestamp)(modalInfo.start), readOnly: true })
                                )
                            ),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    this.translate('form.end')
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    _react2.default.createElement('input', { type: 'text', value: (0, _time.fromOlatTimestamp)(modalInfo.end), readOnly: true })
                                )
                            )
                        )
                    );
                } else if (this.state.modal === 'delete') {
                    var _modalButtons = [{ label: this.translate('btn.delete'), callback: function callback() {
                            return _this2.onEvent('delete', modalInfo);
                        } }, { label: this.translate('btn.cancel'), callback: function callback() {
                            return _this2.onEvent('closeModal');
                        } }];
                    modal = _react2.default.createElement(
                        _OLATModal2.default,
                        { displayed: true, title: this.translate('modal.title.delete'), buttons: _modalButtons, onClose: function onClose() {
                                return _this2.onEvent('closeModal');
                            } },
                        _react2.default.createElement(
                            'p',
            ...
            return _react2.default.createElement(
                _OLATLoadingIndicator2.default,
                { loading: this.state.loading },
                _react2.default.createElement(_MeetingsTable2.default, { key: 'past', list: pastMeetings, listeners: [this], emptyMessage: this.translate('no.past.meetings') }),
                _react2.default.createElement(_MeetingsTable2.default, { key: 'future', list: futureMeetings, listeners: [this], emptyMessage: this.translate('no.future.meetings') }),
                modal
            );
        }
    }, {
        ...
        value: function onEvent(cmd, params) {
            ...
            console.log('Meetings.onEvent()', cmd, params);
            if (cmd === 'edit') {
                this.setState({ modal: 'edit', modalInfo: params });
            } else if (cmd === 'save') {
                var vm = this;
                var meetingToSave = params;
                var postParams = { courseId: this.props.courseId, nodeId: this.props.nodeId, meetingId: meetingToSave.scoId };
                _axios2.default.post((0, _api.getApiEndpoint)('savemeeting', postParams), meetingToSave).then(function (response) {
                    if (response.data.result === 1) {
                        var newMeetings = _this3.state.meetings.map(function (meeting) {
                            return meeting.scoId === meetingToSave.scoId ? _extends({}, meetingToSave) : _extends({}, meeting);
                        });
                        vm.setState({ modal: '', meetings: newMeetings });
                    }
                }).catch(function (error) {
                    console.log('Could not save meeting', meetingToSave, error);
                });
            } else if (cmd === 'confirmDelete') {
                this.setState({ modal: 'delete', modalInfo: params });
            } else if (cmd === 'delete') {
                var _vm = this;
                var meetingToDelete = params;
                var _postParams = { courseId: this.props.courseId, nodeId: this.props.nodeId, meetingId: meetingToDelete.scoId };
                _axios2.default.post((0, _api.getApiEndpoint)('deletemeeting', _postParams), { id: meetingToDelete.scoId }).then(function (response) {
                    if (response.data.result === 1) {
                        var newMeetings = _this3.state.meetings.filter(function (meeting) {
                            return meeting.scoId !== params.scoId;
                        });
                        _vm.setState({ modal: '', meetings: newMeetings });
                    }
                }).catch(function (error) {
                    console.log('Could not delete meeting', meetingToDelete, error);
                });
            } else if (cmd === 'closeModal') {
                this.setState({ modal: '' });
            } else {
                _get(Meetings.prototype.__proto__ || Object.getPrototypeOf(Meetings.prototype), 'onEvent', this).call(this, cmd, params);
            }
        }
    }, {
        key: 'getTranslations',
            ...
            switch (language) {
                ...
                default:
                    return {
                        ...
                        "modal.title.edit": "Edit meeting details",
                        "no.future.meetings": "There are no active/future meetings",
                        "no.past.meetings": "There are no finished meetings"
                    };
            }
        }
    }, {
        key: 'setModalInfo',
        value: function setModalInfo(field, value) {
            var modalInfo = _extends({}, this.state.modalInfo);
            modalInfo[field] = value;
...
var OLATModal = function (_React$Component) {
    _inherits(OLATModal, _React$Component);

    function OLATModal(props) {
        _classCallCheck(this, OLATModal);

        var _this = _possibleConstructorReturn(this, (OLATModal.__proto__ || Object.getPrototypeOf(OLATModal)).call(this, props));

        _this.onClose = _this.onClose.bind(_this);
        return _this;
    }

    _createClass(OLATModal, [{
        key: 'render',
        value: function render() {
            var customClass = this.props.customClass || '';
            var buttons = this.props.buttons || [];
            var modalSize = this.props.size || ''; // modal-sm, modal-lg, custom...

            return this.props.displayed || false ? _react2.default.createElement(
                'div',
                { className: 'olat_modal modal-open' + customClass },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'close', onClick: this.onClose },
                                    '\xD7'
                                ),
                                _react2.default.createElement(
                                    'h4',
                            ...
                            buttons.length > 0 ? _react2.default.createElement(
                                ...
                                buttons.map(function (buttonInfo, buttonIndex) {
                                    return _react2.default.createElement(
                                        'button',
                                        { type: 'button', key: buttonIndex, className: buttonInfo.class, onClick: buttonInfo.callback },
                                        buttonInfo.label
                                    );
                                })
                            ) : ''
            ...
            ) : _react2.default.createElement('div', { className: 'olat_modal olat_modal_hidden ' + customClass });
        }
    }, {
        key: 'onClose',
        value: function onClose() {
            if (this.props.onClose) {
                ...
                console.log('OLATModal.onClose is undefined');
            }
        }
    }]);
 ...
 * expected props:
 *   loading: boolean
 *   children: anything that should be rendered whenever loading is set to false
 */
var OLATLoadingIndicator = function (_OLATComponent) {
    _inherits(OLATLoadingIndicator, _OLATComponent);

    function OLATLoadingIndicator() {
        _classCallCheck(this, OLATLoadingIndicator);

        return _possibleConstructorReturn(this, (OLATLoadingIndicator.__proto__ || Object.getPrototypeOf(OLATLoadingIndicator)).apply(this, arguments));
    }

    _createClass(OLATLoadingIndicator, [{
        key: 'render',
        value: function render() {
    ...
    return OLATLoadingIndicator;
}(_OLATComponent3.default);

exports.default = OLATLoadingIndicator;
...
function getApiEndpoint(key, params) {
    console.log('getApiEndpoint', params);
    var endpoints = listApiEndpoints();
    console.log('all endpoints:', endpoints);
    var url = key in endpoints ? endpoints[key] : '';
    console.log('keys', Object.keys(_extends({}, params)));
    Object.keys(_extends({}, params)).forEach(function (paramKey) {
        console.log('parameter: ', paramKey, params[paramKey]);
...
function listApiEndpoints() {
    var env = 'ENV' in localStorage ? localStorage.getItem('ENV') : '';
    switch (env.toUpperCase()) {
        case 'TEST':
        case 'PROD':
            return {
                "listmeetings": "/restapi/swin/{courseId}/{nodeId}/meetings",
                "createmeeting": "/restapi/swin/{courseId}/{nodeId}/meetings/",
                "savemeeting": "/restapi/swin/{courseId}/{nodeId}/meetings/{meetingId}",
                "deletemeeting": "/restapi/swin/{courseId}/{nodeId}/meetings/{meetingId}"
            };
        default:
            return {
                "listmeetings": "api/meetings7.php?courseId={courseId}&nodeId={nodeId}",
                "savemeeting": "api/savemeeting.php",
                "deletemeeting": "api/deletemeeting.php"
            };
    }
}
...
var _OLATSortableTable2 = __webpack_require__(81);

var _OLATSortableTable3 = _interopRequireDefault(_OLATSortableTable2);

var _OLATSortableTableColumnHeader = __webpack_require__(69);

var _OLATSortableTableColumnHeader2 = _interopRequireDefault(_OLATSortableTableColumnHeader);
...
/**
 * expected props: same as for parent class (OLATSortableTable)
 */
var MeetingsTable = function (_OLATSortableTable) {
    _inherits(MeetingsTable, _OLATSortableTable);

    function MeetingsTable() {
        _classCallCheck(this, MeetingsTable);

        return _possibleConstructorReturn(this, (MeetingsTable.__proto__ || Object.getPrototypeOf(MeetingsTable)).apply(this, arguments));
    }

    _createClass(MeetingsTable, [{
        key: 'onEvent',
        value: function onEvent(cmd, params) {
            _get(MeetingsTable.prototype.__proto__ || Object.getPrototypeOf(MeetingsTable.prototype), 'onEvent', this).call(this, cmd, params);
        }
    }, {
        key: 'renderHeaders',
        value: function renderHeaders(columns) {
            var vm = this;
            return _react2.default.createElement(
                'tr',
                null,
                _react2.default.createElement(_OLATSortableTableColumnHeader2.default, { columnInfo: { name: 'name', label: 'Name', sortable: true }, sortColumn: this.state.sortColumn, sortAsc: this.state.sortAsc, listeners: [this] }),
                _react2.default.createElement(_OLATSortableTableColumnHeader2.default, { columnInfo: { name: 'start', label: 'Start', sortable: true }, sortColumn: this.state.sortColumn, sortAsc: this.state.sortAsc, listeners: [this] }),
                _react2.default.createElement(_OLATSortableTableColumnHeader2.default, { columnInfo: { name: 'end', label: 'End', sortable: false } }),
                _react2.default.createElement(
                    'th',
                    { key: 'actions' },
                    '\xA0'
        ...
        key: 'renderRow',
        value: function renderRow(meetingInfo, columns, index) {
            var vm = this;
            return _react2.default.createElement(
                'tr',
                { key: index },
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    (0, _time.fromOlatTimestamp)(meetingInfo.start).toLocaleDateString()
                ),
                _react2.default.createElement(
                    'td',
                    null,
                    (0, _time.fromOlatTimestamp)(meetingInfo.end).toLocaleDateString()
                ),
                _react2.default.createElement(
                    'td',
                    null,
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: 'javascript:', onClick: function onClick() {
                                vm.onEvent('confirmDelete', meetingInfo);
                            } },
...
}(_OLATSortableTable3.default);

exports.default = MeetingsTable;
 ...
 *   columns : array of json objects with keys 'name' (string), 'label' (string), 'sortable' (boolean)
 */
var OLATSortableTable = function (_OLATComponent) {
    _inherits(OLATSortableTable, _OLATComponent);

    function OLATSortableTable(props) {
        _classCallCheck(this, OLATSortableTable);

        var _this = _possibleConstructorReturn(this, (OLATSortableTable.__proto__ || Object.getPrototypeOf(OLATSortableTable)).call(this, props));

        _this.state = _extends({}, _this.state, {
            sortColumn: _this.props.sortColumn || "",
            sortAsc: 'sortAsc' in _this.props ? _this.props.sortAsc : true
        });
    ...
    _createClass(OLATSortableTable, [{
        key: 'render',
        value: function render() {
            var _this2 = this;

            var columns = this.props.columns || [];
            var list = this.sort([].concat(_toConsumableArray(this.props.list)), this.state.sortColumn, this.state.sortAsc);
            return list.length > 0 ? _react2.default.createElement(
                'table',
                ...
                _react2.default.createElement(
                    ...
                    list.map(function (item, index) {
                        return _this2.renderRow(item, columns, index);
                    })
                )
            ) : _react2.default.createElement(
                'h3',
        ...
        key: 'onEvent',
        value: function onEvent(cmd, params) {
            console.log('OLATSortableTable.onEvent()', cmd, params);
            if (cmd === 'sort') {
                if ('column' in params) {
                    var sortAsc = this.state.sortColumn === params.column ? !this.state.sortAsc : true;
                    this.setState({ sortColumn: params.column, sortAsc: sortAsc });
                }
            } else {
                this.sendMessage(cmd, params);
            }
        ...
        value: function renderHeaders(columns) {
            ...
            return _react2.default.createElement(
                ...
                columns.map(function (columnInfo, index) {
                    return _react2.default.createElement(_OLATSortableTableColumnHeader2.default, { columnInfo: columnInfo, sortColumn: vm.state.sortColumn, sortAsc: vm.state.sortAsc, listeners: [vm] });
                })
            );
        }
    }, {
        key: 'renderRow',
        value: function renderRow(item, columns, rowIndex) {
            return _react2.default.createElement(
                'tr',
                { key: rowIndex },
                columns.map(function (columnInfo, columnIndex) {
                    return _react2.default.createElement(
                        'td',
                        { key: columnIndex },
        ...
        key: 'sort',
        value: function sort(list, sortColumn, ascending) {
            var vm = this;
            list.sort(function (a, b) {
                return ascending ? vm.compare(a, b, sortColumn) : vm.compare(b, a, sortColumn);
            });
            return list;
        }
    }, {
        key: 'compare',
        value: function compare(a, b, columnName) {
    ...
    return OLATSortableTable;
}(_OLATComponent3.default);

exports.default = OLATSortableTable;
